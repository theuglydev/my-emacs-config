...
(setq company-tooltip-flip-when-above t)     ; Flip the tooltip when it's above the point
(setq company-minimum-prefix-length 1)       ; Show suggestions after typing one character
